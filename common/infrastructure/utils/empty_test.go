...
func TestZero(t *testing.T) {
	...
	for i, test := range []struct {
		...
		if utils.IsEmpty(test.v) != test.want {
...
// 	log.Println(utils.IsEmpty(zeroStructure))        // true
// 	log.Println(utils.IsEmpty(zeroStructurePointer)) // true
// 	log.Println(utils.IsEmpty(nonZero))              // false
// 	log.Println(utils.IsEmpty(nonZeroPointer))       // false
// 	// Output:
// 	// true
// 	// true
// 	// false
